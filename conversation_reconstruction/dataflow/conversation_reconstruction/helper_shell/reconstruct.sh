...
do
    ...
    python dataflow_main.py --input gs://wikidetox-viz-dataflow/ingested/en-20180501/20180501-en/date-{week}at{year}/revisions*.json --week $i --year 2002 --setup_file ./setup.py || exit
done
