...
python dataflow_main.py --input gs://wikidetox-viz-dataflow/ingested/en-20180501/20180501-en/date-[5-9]at2001/revisions*.json --setup_file ./setup.py --process_file test_tmp --output_name test --testmode --project wikidetox-viz --bucket wikidetox-viz-dataflow
