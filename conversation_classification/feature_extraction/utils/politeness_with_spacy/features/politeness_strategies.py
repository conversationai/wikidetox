...
firstperson.__name__ = b"1st person"
...
secondperson_start.__name__ = b"2nd person start"
...
secondperson.__name__ = b"2nd person"
...
initial_polar.__name__ = b"Initial Polar"

aux_polar = lambda p: getdeptag(p) == "aux" and getright(p) in polar_set
aux_polar.__name__ = b"Aux Polar"
