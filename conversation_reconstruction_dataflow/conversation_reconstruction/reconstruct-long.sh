...
#    gsutil -m rm gs://wikidetox-viz-dataflow/process_tmp/longpages_bakup/*
    ...
    python dataflow_main.py --category longpages --input gs://wikidetox-viz-dataflow/sharded_ingested_long_pages/date-{week}at{year}/revisions-*.avro --week $i --year 2008 --setup_file ./setup.py 
done
