...
if __name__ == '__main__':
  ...
  parser.add_argument('--input_page_state_table',
                      ...
                      default='wikidetox_conversations.page_states_long_missing',
  ...
  parser.add_argument('--page_states_output_table',
                      ...
                      default='wikidetox-viz:wikidetox_conversations.page_states_long_missing',
  ...
  for year in range(2006, 2007):
      for week in range(8, 16):
          ...
          known_args.output_table = 'wikidetox-viz:wikidetox_conversations.reconstructed_long_pages_missing_weeks'
